 ...
 * kr_close_bet_calibration에서 읽은 2026-09-01 시점 값, 2025-02-04~2026-08-28:
 *
 *   소형  1,410건 · 347일 등장 · 하루 3.7건 · 상회 70% · +4.606%p
 *   중형    433건 · 199일 등장 · 하루 1.1건 · 상회 54% · +1.209%p
 *   대형    284건 · 160일 등장 · 하루 0.8건 · 상회 55% · +1.657%p
 *
 * **대형은 이틀에 하나꼴입니다.** 여기 적혀 있던 예전 숫자(대형 1,502건 · 하루
 * 4.9건)는 회전율 문턱을 넣기 전 조건의 것이라, 화면을 보고 "대형이 왜 안 뜨나"
 * 싶게 만들었습니다. 조건을 바꾸면 이 숫자도 같이 고치세요 -- 캘리브레이션
 * 테이블이 늘 실제 값이고 이 주석은 그것의 사본입니다.
 *
 * 소형이 다섯 배 많은 것은 편향이 아니라 측정된 빈도입니다. 시총 최상단은
 * 회전율 5%를 사실상 못 넘습니다 -- 2026-08-31 기준 삼성전자는 주식수가
 * 58.5억주라 5%면 하루 2.9억주이고 실제로는 1,700만주(0.29%) 거래됐습니다.
 * 대형주를 더 보고 싶으면 규모별 회전율 문턱을 **재고 나서** 바꾸세요.
 */
